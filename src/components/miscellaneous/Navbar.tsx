...
const Navbar = () => {
  ...
  const links = [
    ...
    // { path:'/about', text: 'navbar:about', paths: ['/about', '/en/about','/es/about','/ua/about'] },
    {
      path: "/contact",
      text: "navbar:contact",
      paths: ["/contact", "/en/contact", "/es/contact", "/ua/contact"],
    },
  ];
  ...
  const burger = (
    <Button
      ...
      className="text-[var(--foreground)] hover:text-[var(--foreground)] font-medium bg-[red]
            bg-transparent hover:bg-[var(--background-2)] rounded-0
  ...
  return (
    <div className="relative w-full z-[8000]">
      ...
      >
        <div
          className="grid grid-cols-2 md:grid-cols-[150px_1fr_150px] 
              ...
              return (
                <Button
                  ...
                  className={`hover:text-[var(--foreground-2)] font-medium
                                    hover:bg-[var(--background-2)] px-3.5
                                    ${
                  ...
                  {links?.map((link, key) => {
                    return (
                      <Button
                        ...
                        variant="light"
                        className={`hover:text-[var(--foreground-2)] font-medium
                                        hover:bg-[var(--background-2)] py-5 w-full
                      ...
                      >
                        <div
                          className="relative w-full py-2 md:py-3 items-center
