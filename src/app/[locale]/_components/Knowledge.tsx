...
const Knowledge = () => {
  ...
  return (
    <div className="relative w-full h-fit duration-100 px-5 md:px-10 py-20 flex justify-center">
      <div
        className="relative w-full max-w-screen-xl bg-[var(--background-3)]
      ...
      >
        <LazyMotion features={domAnimation}>
          ...
          >
            <div className="relative flex flex-col gap-3">
              ...
              <p
                className="text-sm tracking-wider text-[var(--foreground-3)]
            ...
            <div className="relative flex flex-col gap-3">
              <h3 className="text-sm font-medium text-[var(--foreground-6)] tracking-wider">
                {t("a-title-2", { ns: "home" })}
              </h3>
              <p
                className="text-sm tracking-wider text-[var(--foreground-3)]
        ...
        <LazyMotion features={domAnimation}>
          ...
          >
            ...
            <div className="relative flex flex-col gap-3">
              <h3 className="text-sm font-medium text-[var(--foreground-6)]">
                {t("b-title-2", { ns: "home" })}
              </h3>
              <p
                className="text-sm tracking-wider text-[var(--foreground-3)]
