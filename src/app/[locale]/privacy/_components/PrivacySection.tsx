...
const PrivacySection = () => {
  ...
  return (
    ...
    >
      <div
        className="relative gap-10 w-full max-w-screen-xl duration-100
      ...
      >
        ...
        >
          <div
            className="relative sm:sticky sm:top-[90px] sm:left-0 
                        text-[var(--foreground-5)] text-4xl md:text-5xl font-medium
                    "
          >
            <div className="flex flex-row gap-2 items-center">
              <h1>{t("title", { ns: "privacy" })}</h1>
              <FaArrowRight className="hidden sm:block icon pt-1 text-[var(--foreground-4)]" />
            </div>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          <p className="tracking-wider text-[var(--foreground-4)]">
            ...
            <Link
              isExternal
              href="/"
              className="tracking-wider text-[var(--foreground-2)]"
            >
              {t("legal_advise", { ns: "privacy" })}
            </Link>
            .
          </p>
